...
import { PlusIcon, PencilIcon, TrashIcon, ChevronRight, ChevronDown, Folder, FolderOpen, Tag } from "lucide-react";
...
export default function ExpenseCategoryPage() {
    ...
    const handleDelete = (id: string) => {
        if (confirm("Are you sure you want to delete this category?")) {
            dispatch(deleteExpenseCategoryRequest(id));
        }
    };
        ...
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-default-500">Manage categories for expense tracking</p>
                </div>
                        ...
                        <>
                            ...
                            <ModalBody>
                                ...
                                >
                                    {[
                                        { id: "", name: "None (Root)" },
                                        ...(expenseCategories || []).filter((c: any) => c.id !== selectedCategory?.id)
                                    ].map((cat: any) => (
