    ...
    return (
        <div className="w-full min-h-screen bg-[#F9FAFB] dark:bg-[#131314] pt-24 pb-20 px-6 font-sans">
            ...
            >
                ...
                <Link
                    href="/feeds"
                    className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-transparent hover:border-gray-200 dark:hover:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 transition-all duration-200 group mb-8"
                >
                    <ArrowLeft size={16} className="text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-200 group-hover:-translate-x-0.5 transition-all duration-200" />
                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-200">Back to Feeds</span>
                </Link>
                ...
                {/* Title */}
                <h1 className="text-3xl md:text-5xl font-bold text-[#3D3D3D] dark:text-white leading-tight mb-12 text-center max-w-4xl mx-auto">
                    {blog.title}
                </h1>

                {/* Cover Image */}
                {blog.cover_image && (
                    <div className="relative w-full aspect-[16/9] md:aspect-[2/1] overflow-hidden rounded-[24px] mb-8 shadow-sm bg-gray-100 dark:bg-gray-800">
                        <Image
                            removeWrapper
                            alt={blog.title}
                ...
                {blog.excerpt && (
                    <div className="mb-12">
                        <p className="text-[#52525B] dark:text-gray-300 text-base md:text-lg leading-relaxed">
                            {blog.excerpt}
                        </p>
                    </div>
                )}
                ...
                {/* Content */}
                <div className={`${styles.content} dark:text-gray-300`}>
                ...
                {blog.recommendations && blog.recommendations.length > 0 && (
                    <div className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-800">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-8">Recommended for you</h3>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="px-3 pt-4 pb-2 flex flex-col gap-2">
                                            ...
                                            <p className="text-[#52525B] dark:text-gray-400 text-sm leading-relaxed line-clamp-2">
