...
export const GET_EMPLOYEES_SUMMARY_REQUEST = "GET_EMPLOYEES_SUMMARY_REQUEST";
export const GET_EMPLOYEES_SUMMARY_SUCCESS = "GET_EMPLOYEES_SUMMARY_SUCCESS";
export const GET_EMPLOYEES_SUMMARY_FAILURE = "GET_EMPLOYEES_SUMMARY_FAILURE";

export const GET_EMPLOYEE_SUMMARY_DETAILS_REQUEST =
  "GET_EMPLOYEE_SUMMARY_DETAILS_REQUEST";
export const GET_EMPLOYEE_SUMMARY_DETAILS_SUCCESS =
  "GET_EMPLOYEE_SUMMARY_DETAILS_SUCCESS";
export const GET_EMPLOYEE_SUMMARY_DETAILS_FAILURE =
  "GET_EMPLOYEE_SUMMARY_DETAILS_FAILURE";

export const DELETE_EMPLOYEE_DOCUMENT_REQUEST = "DELETE_EMPLOYEE_DOCUMENT_REQUEST";
