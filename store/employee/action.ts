...
export const getEmployeeDashboardSummaryRequest = (id: string) => ({
  type: GET_EMPLOYEE_DASHBOARD_SUMMARY_REQUEST,
  payload: id,
});
export const getEmployeeDashboardSummarySuccess = (response: any) => ({
  type: GET_EMPLOYEE_DASHBOARD_SUMMARY_SUCCESS,
  payload: response,
});
export const getEmployeeDashboardSummaryFailure = (error: any) => ({
  type: GET_EMPLOYEE_DASHBOARD_SUMMARY_FAILURE,
  payload: error,
});
